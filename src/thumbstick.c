...
uint8_t glyphs[32][8] = {
    ...
    {ACTIONS(KEY_A, DIR4_LEFT)},  // Shortcut.
    ...
    {ACTIONS(KEY_E, DIR4_RIGHT)}, // Shortcut.
    ...
    {ACTIONS(KEY_O, DIR4_UP, DIR4_RIGHT, DIR4_DOWN, DIR4_LEFT, DIR4_UP)},  // Alt.
    {ACTIONS(KEY_O, DIR4_UP)},  // Shortcut.
    ...
    {ACTIONS(KEY_PERIOD, DIR4_LEFT, DIR4_UP)},
    {ACTIONS(KEY_COMMA, DIR4_LEFT, DIR4_UP, DIR4_LEFT)},
};
