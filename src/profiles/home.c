...
Profile profile_init_home() {
    ...
    profile.thumbstick = Thumbstick_(
        ...
        // Left & right.
        Button_(PIN_NONE, HOLD_EXCLUSIVE_LONG, ACTIONS(KEY_NONE), ACTIONS(KEY_LEFT_BRACKET)),
        Button_(PIN_NONE, HOLD_EXCLUSIVE_LONG, ACTIONS(KEY_NONE), ACTIONS(KEY_RIGHT_BRACKET)),
        // Up & Down
    ...
    profile.dhat = Dhat_(
        Button_(PIN_NONE, NORMAL, ACTIONS(KEY_F8)),
        Button_(PIN_NONE, HOLD_EXCLUSIVE_LONG, ACTIONS(KEY_F4), ACTIONS(PROC_TUNE_OS)),
        Button_(PIN_NONE, NORMAL, ACTIONS(KEY_F7)),
        Button_(PIN_NONE, HOLD_EXCLUSIVE_LONG, ACTIONS(KEY_F1), ACTIONS(PROC_TUNE_DEADZONE)),
        Button_(PIN_NONE, NORMAL, ACTIONS(KEY_BACKQUOTE)),
        Button_(PIN_NONE, HOLD_EXCLUSIVE_LONG, ACTIONS(KEY_F3), ACTIONS(PROC_TUNE_TOUCH_THRESHOLD)),
        Button_(PIN_NONE, NORMAL, ACTIONS(KEY_F5)),
        Button_(PIN_NONE, HOLD_EXCLUSIVE_LONG, ACTIONS(KEY_F2), ACTIONS(PROC_TUNE_SENSITIVITY)),
        Button_(PIN_NONE, NORMAL, ACTIONS(KEY_F6))
    );
