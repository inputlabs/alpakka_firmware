...
Profile profile_init_home() {
    ...
    profile.dhat = Dhat_(
        ...
        Button_(PIN_VIRTUAL, HOLD_EXCLUSIVE_LONG, ACTIONS(KEY_F3), ACTIONS(PROC_TUNE_TOUCH_SENS)),  // Right.
        Button_(PIN_VIRTUAL, HOLD_EXCLUSIVE_LONG, ACTIONS(KEY_F4), ACTIONS(PROC_TUNE_OS)),               // Up.
        Button_(PIN_VIRTUAL, HOLD_EXCLUSIVE_LONG, ACTIONS(KEY_F2), ACTIONS(PROC_TUNE_MOUSE_SENS)),      // Down.
